...
import static com.visioncamerabarcodescanner.BarcodeConverter.convertToArray;
import static com.visioncamerabarcodescanner.BarcodeConverter.convertToMap;
...
public class VisionCameraBarcodeScannerPlugin extends FrameProcessorPlugin {
  ...
  VisionCameraBarcodeScannerPlugin() {
    super("scanBarcodes");
  }
}
